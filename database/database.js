...
const CLOTHES = [
    { name: "shirt", link: "clothes/shirt.jpg" },
    { name: "t-shirt", link: "clothes/t-shirt.jpg" },
    { name: "jacket", link: "clothes/jacket.jpg" },
    { name: "shorts", link: "clothes/shorts.jpg" },
    { name: "sweater", link: "clothes/sweater.png" },
    { name: "jeans", link: "clothes/jeans.png" },
    { name: "socks", link: "clothes/socks.png" },
    { name: "hat", link: "clothes/hat.png" },
    { name: "underwear", link: "clothes/underwear.png" },
    { name: "gloves", link: "clothes/gloves.png" },
    { name: "scarf", link: "clothes/scarf.png" },
    { name: "coat", link: "clothes/coat.jpg" },
    { name: "skirt", link: "clothes/skirt.jpg" },
    { name: "slippers", link: "clothes/slippers.jpg" },
    { name: "pajamas", link: "clothes/pajamas.png" },
    { name: "pants", link: "clothes/pants.jpg" },
];


const COUNTRIES = [
    { name: "France", link: "country/France.png" },
    { name: "Australia", link: "country/Australia.png" },
    { name: "United Kingdom", link: "country/United Kingdom.png" },
    { name: "Germany", link: "country/Germany.png" },
    { name: "Spain", link: "country/Spain.png" },
    { name: "Ukraine", link: "country/Ukraine.png" },
    { name: "Italy", link: "country/Italy.png" },
    { name: "Poland", link: "country/Poland.png" },
    { name: "Czech", link: "country/Czech.png" },
    { name: "Portugal", link: "country/Portugal.png" },
    { name: "Norway", link: "country/Norway.png" },
    { name: "Austria", link: "country/Austria.png" },
    { name: "Ireland", link: "country/Ireland.png" },
    { name: "Japan", link: "country/Japan.png" },
    { name: "China", link: "country/China.png" },
    { name: "Canada", link: "country/Canada.png" },
    { name: "Sweden", link: "country/Sweden.png" },
...
const KITCHEN = [
    ...
    { name: "ladle", link: "kitchen/ladle.png" },
    { name: "grater", link: "kitchen/grater.png" },
    { name: "plate", link: "kitchen/plate.png" },
    { name: "glass", link: "kitchen/glass.png" },
    { name: "bowl", link: "kitchen/bowl.png" },
    { name: "cup", link: "kitchen/cup.png" },
    { name: "jug", link: "kitchen/jug.png" },
    { name: "kettle", link: "kitchen/kettle.png" },
    { name: "teapot", link: "kitchen/teapot.png" },
    { name: "saucepan", link: "kitchen/saucepan.png" },
    { name: "tray", link: "kitchen/tray.png" },
    { name: "mug", link: "kitchen/mug.png" },
    { name: "rolling pin", link: "kitchen/rolling pin.png" },
    { name: "colander", link: "kitchen/colander.png" },
    { name: "pan", link: "kitchen/pan.png" },
    { name: "cutting board", link: "kitchen/cutting board.png" },
    { name: "napkin", link: "kitchen/napkin.png" },
    { name: "sink", link: "kitchen/sink.png" },
    { name: "gloves", link: "kitchen/gloves.png" },
    { name: "tap", link: "kitchen/tap.png" },
    { name: "cooker", link: "kitchen/cooker.png" },
    { name: "oven", link: "kitchen/oven.png" },
    { name: "dish washer", link: "kitchen/dish washer.png" },
    { name: "fridge", link: "kitchen/fridge.png" },
    { name: "microwave", link: "kitchen/microwave.png" },
    { name: "fruit juicer", link: "kitchen/fruit juicer.png" },
    { name: "toaster", link: "kitchen/toaster.png" },
    { name: "mixer", link: "kitchen/mixer.png" },
    { name: "vaccum cleaner", link: "kitchen/vaccum cleaner.png" },
    { name: "table cloth", link: "kitchen/table cloth.png" },
    { name: "wastebin", link: "kitchen/wastebin.png" },
];
...
const VOCAB_LIST = [
    FOOD, FRUIT, VEGETABLE, DESSERT, DRINK, JOBS, ANIMAL, VERB, DAYS_OF_WEEK, MONTH, WEATHER, SCHOOL, TOWN, STATIONARY, SHAPE, COLOR, NUMBER, KITCHEN, COOKING_VERBS, CLOTHES, COUNTRIES
];

const LABEL_NAMES = ["Food", "Fruit", "Vegetable", "Dessert", "Drink", "Job", "Animal", "Verb", "DOTW", "Month", "Weather", "School", "Town", "Stationary", "Shape", "Color", "Number", "Kitchen", "Cooking Verbs", "Clothes", "Countries"];
